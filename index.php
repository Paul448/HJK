...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <h2>Find the Best and the most comfortable <span>CarForYou</span></h2>
      <p>In online car rental services we offer and give away the most comfortable car according to the coustomer's request.Powered by Kenya general motors.Thankyou for chosing our services.</p>
    </div>
    <div class="row">
